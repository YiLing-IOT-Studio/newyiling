<template>
    <div class="scrollman-box" ref="scrollman_box">
        <swiper class="swiper swiper-no-swiping" id="scroll_home" v-bind:options="Home_Option" ref="scroll_home">
            <swiper-slide><div id="home1" class="home_son"></div></swiper-slide>
            <swiper-slide><div id="home2" class="home_son"></div></swiper-slide>
            <swiper-slide><div id="home3" class="home_son"></div></swiper-slide>
            <swiper-slide><div id="home4" class="home_son"></div></swiper-slide>
